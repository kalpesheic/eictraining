...
subnetSelectorTerms:
 ...
 if we keep only owned, worker nodes will be launch in public or private but if we put tags internal-elb: "1" then worker nodes will be launch only private subnets.
